...
echo ""
echo "[!!!]  REMINDER: After Argo has synced the app and created the CSR,"
echo "   run the following to approve the user and finalize setup:"
echo ""
echo "     ./approve-user.sh --user $user --namespace $org_ns --kubeconfig \$KUBECONFIG"
echo ""