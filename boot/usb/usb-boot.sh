...
talosctl gen config K8s https://10.100.38.102:6443

# set default endpoint and node in talosconfig file:

talosctl --talosconfig talosconfig config endpoint 10.100.38.102
talosctl --talosconfig talosconfig config node 10.100.38.102
